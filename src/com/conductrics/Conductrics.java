...
public class Conductrics {
	...
	// These are the global default properties, Agent instances can over-ride them or fallback.
	...
	public static class Agent {
		...
		private String requestJson(Options opts, String url) {
			...
			try {
				...
				ex.printStackTrace();
				System.out.println("getErrorStream() has: " + readStream(conn.getErrorStream()));
			}
